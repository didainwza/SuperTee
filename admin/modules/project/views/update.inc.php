...
<form role="form" method="post" onsubmit="return check();" action="index.php?content=project&action=edit" enctype="multipart/form-data">
	<div class="row">
		<div class="col-lg-6">
			<div class="form-group">
				<label>รูปภาพ Project <font color="#F00"></font></label>
				<div>
					<img id="img_back" src="../img_upload/project/<?php if($project_detail['project_detail_img'] != "") echo $project_detail['project_detail_img']; else echo "default.png"; ?>" class="img-responsive img-size"  style = "height: 300px; width: 500px;"> 
	...
	<div class="row">
			...
			<div class="form-group">
				...
				<select id="project_detail_type" name="project_detail_type" class="form-control" data-live-search="true" >
					...
					for ($i = 0; $i < count($project_type); $i++) {
						?>
						<option value="<?php echo $project_type[$i]['type_id'] ?>" <? if($project_type[$i]['type_id'] == $project_detail['project_detail_type']) echo "selected";?>><?php echo $project_type[$i]['type_name_th'] ?></option>
						<?
					}
					?>
				</select>
		...
		<div class="col-lg-3">
			<div class="form-group">
				...
				<input id="project_detail_year" name="project_detail_year" class="form-control" value="<? echo $project_detail['project_detail_year'] ?>" >
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-6">
			<div class="form-group">
				...
				<input id="project_detail_name_th" name="project_detail_name_th" class="form-control" value="<? echo $project_detail['project_detail_name_th']?>">
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
				<label>Project name EN<font color="#F00"><b>*</b></font></label>
				<input id="project_detail_name_en" name="project_detail_name_en" class="form-control" value="<? echo $project_detail['project_detail_name_en']?>">
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
				<label>Location TH<font color="#F00"><b>*</b></font></label>
				<input id="project_detail_location_th" name="project_detail_location_th" class="form-control" value="<? echo $project_detail['project_detail_location_th']?>">
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
				<label>Location EN<font color="#F00"><b>*</b></font></label>
				<input id="project_detail_location_en" name="project_detail_location_en" class="form-control" value="<? echo $project_detail['project_detail_location_en']?>">
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
				<label>Scope of work TH<font color="#F00"><b>*</b></font></label>
				<textarea style="width:100%;" rows="8" name="project_detail_scope_th" id="project_detail_scope_th" class="ckeditor"><? echo $project_detail['project_detail_scope_th']?></textarea>
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
				<label>Scope of work EN<font color="#F00"><b>*</b></font></label>
				<textarea style="width:100%;" rows="8"  name="project_detail_scope_en" id="project_detail_scope_en" class="ckeditor"><? echo $project_detail['project_detail_scope_en']?></textarea>
			</div>
		</div>
	</div>
	<div align="right">
		<input type="hidden" id="project_detail_img_o" name="project_detail_img_o" class="form-control" value="<?php echo $project_detail['project_detail_img']?>">
		<input type="hidden" id="project_detail_id" name="project_detail_id" value="<?php echo $project_detail['project_detail_id'] ?>" />
