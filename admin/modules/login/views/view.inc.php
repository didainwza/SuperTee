...
<body>
    <div class="container">
        ...
        <form class="login-panel" action="check_login.php" method="post" target="checklogin">
            <div class="text-center" style="padding:5px; font-size:24px; font-weight:600; color:#448ccb; padding-bottom:20px;">
                ADMIN PANEL
            </div>
            <div align="center"><img style="width:320px; height:120px;" src="../template/backend/images/logo/logo.png"></div>
