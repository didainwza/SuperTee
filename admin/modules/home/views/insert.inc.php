    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="form-group">
                ...
                <div>
                    <img id="img_slide" src="../img_upload/home_slide/default.png" class="img-responsive img-size"> 
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <textarea id="slide_detail_th" name="slide_detail_th" class="form-control" style="min-height: 200px;"></textarea>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                <label>Detail EN<font color=""><b>*</b></font></label>
                <textarea id="slide_detail_en" name="slide_detail_en" class="form-control" style="min-height: 200px;"></textarea>
            </div>
        </div> 
        <div class="col-lg-6">
            <div class="form-group">
