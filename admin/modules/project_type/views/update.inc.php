...
<form role="form" method="post" onsubmit="return check();" action="index.php?content=project_type&action=edit" enctype="multipart/form-data">
  <div class="row">
    <div class="col-lg-3">
      <div class="form-group">
        <label>Project type TH<font color="#F00"><b>*</b></font></label>
        <input id="type_name_th" name="type_name_th" class="form-control" maxlength="150" value="<?php echo $project['type_name_th']?>">
      </div>
    </div>
    <div class="col-lg-3">
      <div class="form-group">
        <label>Project type EN<font color="#F00"><b>*</b></font></label>
        <input id="type_name_en" name="type_name_en" class="form-control" maxlength="150" value="<?php echo $project['type_name_en']?>">
      </div>
    </div>
  </div>
  <div align="right">
    <input type="hidden" id="type_id" name="type_id" value="<?php echo $project['type_id'] ?>" />
