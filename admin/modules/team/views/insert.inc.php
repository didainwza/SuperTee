...
<form role="form" method="post" onsubmit="return check();" action="index.php?content=team&action=add" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-9">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input id="name_th" name="name_th" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>Name EN <font color="#F00"><b>*</b></font></label>
                        <input id="name_en" name="name_en" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>Position TH <font color="#F00"><b>*</b></font></label>
                        <input id="position_th" name="position_th" class="form-control">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>Position EN <font color="#F00"><b>*</b></font></label>
                        <input id="position_en" name="position_en" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3">
            <div class="form-group" align="center">
                <img id="img_team" src="../img_upload/team/default.png" class="example-avater"> 
                <input accept=".jpg , .png" type="file" id="team_image" name="team_image" class="form-control" style="margin: 14px 0 0 0 ;" onChange="readURL(this);">
            </div>
        </div>
    </div>
