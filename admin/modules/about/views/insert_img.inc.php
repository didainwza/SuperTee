...
<h1>เพิ่มรูปAbout US</h1>
<div align="right">

</div>

<form role="form" method="post" onsubmit="return check();" action="index.php?content=about&action=add_img" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-3">
            <div class="form-group">
                <label>รูปภาพ <font color="#F00"></font></label>
                <div>
                    <img id="img_detail" src="../img_upload/about_img/default.png" class="img-responsive img-size"> 
    ...
    <div align="right">
       <input type="hidden" id="about_detail_id" name="about_detail_id" value="<?php echo $_GET['detail_id'] ?>" />
