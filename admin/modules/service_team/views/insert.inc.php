...
<h1>เพิ่ม Service Team</h1>
<div align="right">

</div>

<form role="form" method="post" onsubmit="return check();" action="index.php?content=service_team&action=add" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-9">
            <div class="row">
                <div class="col-lg-6">
        ...
        <div class="col-lg-3">
            <div class="form-group" align="center">
                <img id="img_team" src="../img_upload/service_team/default.png" class="example-avater"> 
